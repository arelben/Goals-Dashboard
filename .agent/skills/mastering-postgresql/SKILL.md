...
description: >
  ...
  Trigger: When user asks to create search features, store AI embeddings, query vector similarity, optimize PostgreSQL indexes, or deploy to AWS RDS/Aurora, GCP Cloud SQL/AlloyDB, or Azure.
metadata:
  author: arelben
  scope: [root]
  auto_invoke: "creating/modifying PostgreSQL related code"
allowed-tools:
  - Read
  - Bash
  - Write
