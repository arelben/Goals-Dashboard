...
description: >
  ...
  Trigger: When user asks to set up project memory, track our decisions, log a bug fix, update project memory, or initialize memory system.
metadata:
  author: arelben
  version: "1.0"
  scope: [root]
  auto_invoke: "Setting up project memory"
